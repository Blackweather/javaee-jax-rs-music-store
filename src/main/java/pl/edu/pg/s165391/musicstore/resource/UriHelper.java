...
public class UriHelper {
    /**
     * Creates parametrized local (without hostname) URI to the the resource. When passed to the Response.created is converted
     ...
     * @param params values used to fill method params
     * @return parametrized URI to the method in the JAX-RS resource
     */
    public static URI uri(Class<?> clazz, String method, Object... params) {
    ...
    /**
     * Creates parametrized local (with hostname) URI to the resource.
     *
     ...
     * @param clazz JAX-RS resource class
     * @param method text name of the JAX-RS resource class method to which uri should point
     * @param page page number for paginations
     * @param params values used to fill method path params
     * @return parametrized URI to the method in the JAX-RS resource
     */
